  ...
  return (
    <HeaderContainer>
      ...
      <TitleContainer>
        ...
        <Subtitle>Welcome to the Teacher Portal</Subtitle>
      </TitleContainer>
      <Nav>
        <NavList>
          <NavItem>
          ...
          <NavItem>
            <NavLink to="/teacher/performance">
          ...
          <NavItem>
            <NavLink to="/teacher/communication">
              Communication <DropdownIcon />
            </NavLink>
            <DropdownMenu>
              <DropdownItem>
